...
for crypto in all_tickers:
    if any(crypto in x for x in onlyfiles):
        try:
            ...
            print(df_master['count'] + df['count'])
...
df_master['sengen_2'] = df_master['uptrend_2'] / df_master['count']
df_master['sengen_5'] = df_master['uptrend_5'] / df_master['count']
df_master['sengen_10'] = df_master['uptrend_10'] / df_master['count']
